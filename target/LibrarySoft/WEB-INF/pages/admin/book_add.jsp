    ...
    <form:form action="add" method="post" modelAttribute="book">
        <table class="table table-borderless">
            ...
            <tr>
                <td></td>
                <td>
                    <a href="addAuthor" class="btn btn-outline-dark" type="button" style="width: 100%">New Author</a>
                </td>
            </tr>
            <tr>
        ...
        <button type="submit" class="btn btn-outline-dark" style="width: 100%">Add Book</button>
    </form:form>
</div>
</body>
</html>